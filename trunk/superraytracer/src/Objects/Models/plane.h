...
namespace Object
{
	namespace Models
	{
		...
		public:
			...
			virtual RayTracing::HitInfo_t* rayIntersectsInParallel(const RayTracing::Ray_t *rays, const float t0, const float t1, const int w, const int h, int bjHitIndex) const;
